...
_Sanjay_: **"**It's hard for me to pick just one track from Yazz's latest album, 'La Saboteuse'. In this atmospheric title track the contrasting bass clarinet and gentle percussion create a foreboding effect, like a craggy autumnal landscape.**"**
...
_Sanjay_: **"**We try to remain in passage and resist drawing conclusions with this title track from an album by the [Vijay Iyer Trio](http://vijay-iyer.com/) explicitly delighting between revision and the break. If you haven't done so already, I'd recommend hearing Vijay—alongside his many ensembles—live!**"**

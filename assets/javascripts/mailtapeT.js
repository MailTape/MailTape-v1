...
$("#mobile-signup-form").submit(function(e){
	...
	// petit défilement doux et lent qui se déclenche après la lecture pour plonger l'auditeur dans la lecture du texte..
		...
		for (var i = 0; i < 6; i++) {
			$("#relatedEpisode_a_"+(i+1)).attr("data-stretch","https://images.weserv.nl/?url=mailta.pe"+relatedEpisodes_selection[i][3]+"&w=400&t=fit&il");
			...
			$("#relatedEpisode_img_"+(i+1)).attr("src","https://images.weserv.nl/?url=www.mailta.pe"+relatedEpisodes_selection[i][4]+"&il");
		}

...
// mini fleur musicolor
	    ...
	    if (typeof relatedEpisodes_numbers[0] !== 'undefined') {
			...
			for (var i = 0; i < 6; i++) {
				$("#relatedEpisode_a_"+(i+1)).attr("data-stretch","//wsrv.nl/?url=ssl:www.mailta.pe"+relatedEpisodes_selection[i][3]+"&w=400&t=fit&il");
				...
				$("#relatedEpisode_img_"+(i+1)).attr("src","//wsrv.nl/?url=ssl:www.mailta.pe"+relatedEpisodes_selection[i][4]+"&il");
			}
